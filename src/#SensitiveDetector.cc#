...
G4int SensitiveDetector::GetEvtType(){return EvtType;}
G4double SensitiveDetector::GetKinEnIn(){return KinEnIn;}
G4double SensitiveDetector::GetTrackLenInVol(){return TrackLenInVol;}
G4double SensitiveDetector::GetTrackLenPrior(){return TrackLenPrior;}
G4double SensitiveDetector::GetVertexX(){return VertexX;}
G4double SensitiveDetector::GetVertexZ(){return VertexZ;}
G4double SensitiveDetector::GetVertexR(){return VertexR;}
G4double SensitiveDetector::GetEdep(){return EdepThisEventUnquenched;}
...
G4bool SensitiveDetector::ProcessHits(G4Step* theStep, G4TouchableHistory*){
  ...
  //G4cout << "Particle Stepping in Front Vial!" << G4endl;
...
void SensitiveDetector::EndOfEvent(G4HCofThisEvent*)
{
  ...
  if(EdepThisEventUnquenched!=0){
    ...
    if(myRunAction){
      ...
      //myRunAction->TallyEvtDataFront(EvtType, KinEnIn,EdepThisEventUnquenched,
