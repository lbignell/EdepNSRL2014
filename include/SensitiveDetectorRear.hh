...
#ifndef SensitiveDetectorRear_h
#define SensitiveDetectorRear_h 1
...
class SensitiveDetectorRear : public G4VSensitiveDetector
{

public:
    SensitiveDetectorRear(G4String name);
    ~SensitiveDetectorRear();
