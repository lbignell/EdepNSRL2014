...
#ifndef SensitiveDetectorPMT_h
#define SensitiveDetectorPMT_h 1
...
class SensitiveDetectorPMT : public G4VSensitiveDetector
{

public:
    SensitiveDetectorPMT(G4String name);
    ~SensitiveDetectorPMT();
